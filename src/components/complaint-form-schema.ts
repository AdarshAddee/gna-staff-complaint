...
export const complaintSchema = z.object({
  ...
  issue: z.string().max(500000, { message: "Issue description cannot exceed 500000 characters." }), 
  comment: z.string().max(100000, { message: "Comment cannot exceed 100000 characters." }).optional().default(""),
});
